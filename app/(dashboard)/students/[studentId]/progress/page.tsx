...
import { aggregateDataPoints, formatAccuracy } from "@/lib/utils/calc-accuracy";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold">Progress Notes</h2>
          <p className="text-sm text-muted-foreground mt-0.5">
            Goal-by-goal performance summary for {student.firstName} {student.lastName}
          </p>
        </div>
      </div>
