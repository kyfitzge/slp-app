  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b last:border-0">
      ...
      <div className="text-right flex-1 min-w-0 pl-4">
        {missing ? (
          <span className="inline-flex items-center gap-1 text-sm font-medium text-amber-700 bg-amber-50 border border-amber-200 rounded px-2 py-0.5">
                ...
                <div className="rounded-lg border divide-y">
                  ...
                  <div className="px-4 py-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-2 text-sm text-muted-foreground min-w-[130px] pt-0.5">
                        <Users className="h-3.5 w-3.5 shrink-0" />
                        Students Present
                      </div>
                        ...
                        {students.map((s) => {
                          ...
                          return (
                            <div key={s.id} className="flex items-center gap-2 justify-end">
                              ...
                              <span className={cn(
                                "text-sm font-medium rounded px-1.5 py-0.5",
